...
\section{Consequences of Centralization}
...
% Maybe these should be subsubsections
...
% Hesistate to structure it like this. Problem -> Design decision -> Feature
% We don't need to involve the reader in the decision making process - everyone thinks they know better so it may seed doubt here.
% It might be better to do feature -> why it's a solution to problem, because we've packed the intro with problems. It should also be more concise and snappy that way.
